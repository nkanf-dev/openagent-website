...
![Records page showing recent audit entries and operator actions](/img/docs/openagent/auditing-records-list.png)

![Usage page showing token and message trends over time](/img/docs/openagent/auditing-usage-trends.png)
