...
<Callout type="info">
  User lifecycle management is handled by Casdoor. For the full user-management UI and field reference, see [Casdoor User Overview](https://casdoor.ai/docs/user/overview).
</Callout>
