...
<Callout type="info">
  The provider form changes dynamically based on the selected **Type**, so the exact fields shown will vary between OpenAI, Azure, Bedrock, Ollama, and other backends.
</Callout>

![Model provider type selector and conditional fields](/img/docs/openagent/model-provider-types.png)
